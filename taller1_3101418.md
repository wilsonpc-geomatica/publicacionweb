...
- Una vez obtenido el mapa en Qgis, se procede a cargarlo generar el servicio geografico WMS mediante la carga usando el software libre Qgis Cloud, se actualizan las capas y se cargan los datos:

![carga1](images/giscloud_carga.jpg)
...
![carga2](images/qgiscloud_pub_zoom)
